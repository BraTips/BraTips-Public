  ...
  <div class="app">
    ...
    <footer v-if="!minimalChrome">
      <div class="wrap foot">
        ...
        <div><b>Information</b><RouterLink to="/about">About BraTipsters</RouterLink><RouterLink to="/editorial-policy">Editorial Policy</RouterLink><RouterLink to="/results-tracking-policy">Results Tracking Policy</RouterLink><RouterLink to="/betting-guides">Betting Guides</RouterLink><RouterLink to="/glossary">Glossary</RouterLink><RouterLink to="/blog">Blog</RouterLink><RouterLink to="/terms-of-use">Terms of Use</RouterLink><RouterLink to="/privacy-policy">Privacy & Cookie Policy</RouterLink><RouterLink to="/contact">Contact BraTipsters</RouterLink></div><div><b>Community</b><RouterLink to="/community">Community Hub</RouterLink><a :href="socialLinks.discord" target="_blank" rel="noopener noreferrer">Discord</a><a :href="socialLinks.facebook" target="_blank" rel="noopener noreferrer">Facebook</a><a :href="socialLinks.telegram" target="_blank" rel="noopener noreferrer">Telegram</a><a :href="socialLinks.instagram" target="_blank" rel="noopener noreferrer">Instagram</a></div>
      </div>
