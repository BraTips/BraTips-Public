<template>
  <div class="pro-page page-animate"><div class="wrap tipster-prediction-detail">
    ...
    <template v-else>
      ...
      <section v-if="prediction.locked" class="pro-panel tipster-prediction-locked"><span class="premium-badge">PREMIUM TIP</span><h1>Selection locked</h1><p>{{ fixture }}</p><p class="muted">Subscribe to reveal this tipster's selection and quoted odds.</p><RouterLink to="/subscription" class="btn">View plans</RouterLink></section>
      <template v-else>
