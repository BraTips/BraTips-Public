<template>
  <section class="pro-panel td-simple-page">
    ...
    <div class="td-payout-card">
      ...
      <div class="td-payout-foot"><span>Double-check your payout details before submitting.</span><button class="btn" :disabled="submitting||available<10||!payout.accountName||!payout.accountNumber||!payout.institution" @click="request"><BrandedLoader v-if="submitting" label="Submitting"/><template v-else>Request {{ formatMoney(available) }} withdrawal</template></button></div>
...
import BrandedLoader from '../components/BrandedLoader.vue'; import { formatMoney } from '../utils/formatters'
